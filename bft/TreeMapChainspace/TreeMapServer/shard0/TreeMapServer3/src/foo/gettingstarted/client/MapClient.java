        ...
        try {
            ...
            for(String input: t.inputs) {
                ...
                if(!sentShards[shardID]) {
                    ...
                    if(reply != null)
                        replies[shardID] = new String(reply, "UTF-8");
                }
            }
            ...
            for(int i=0; i<replies.length; i++) {
                ...
                if( sentShards[i] && (replies[i] == null || !(replies[i].equals(Transaction.VALID))))
                    return ResponseType.PREPARED_T_ABORT;
            }
