...
class ChainspaceNetwork(object):
    ...
    def start_core_all(self):
        ...
        command = 'screen -dmS chainspacecore java -cp chainspace/chainspacecore/lib/bft-smart-1.2.1-UCL.jar:chainspace/chainspacecore/target/chainspace-1.0-SNAPSHOT-jar-with-dependencies.jar uk.ac.ucl.cs.sec.chainspace.bft.TreeMapServer chainspace/chainspacecore/ChainSpaceConfig/config.txt'
        self.ssh_exec(command)
